...
public class MathUtil {
  ...
  public static float pow(float x, float exponent) {
    ...
    public static double hoursToRadian(double rightAscensionHours, double rightAscensionMinutes, double rightAscensionSeconds) {
      return rightAscensionHours * Math.PI  /12.0 + rightAscensionMinutes * Math.PI  /720.0 + rightAscensionSeconds * Math.PI  /43200.0;
    }
  public static double degreesToRadian(double declenationDegrees, double declenationMinutes, double declenationSeconds) {
    declenationDegrees = declenationDegrees + declenationMinutes / 60.0 + declenationSeconds / 3600.0;
    return Math.toRadians(declenationDegrees);
