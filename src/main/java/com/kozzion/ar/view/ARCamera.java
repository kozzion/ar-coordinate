...
public class ARCamera extends ViewGroup implements SurfaceHolder.Callback {
    ...
    private void generateProjectionMatrix() {
        ...
        double thetaV = Math.toRadians(p.getVerticalViewAngle()); // TODO this is static

        float ratio = (float) this.canvasWidth / this.canvasHeight;
        final int OFFSET = 0;
        //Log.e(TAG, "generateProjectionMatrix: " + p.getVerticalViewAngle());
        //Log.e(TAG, "generateProjectionMatrix: " + p.getHorizontalViewAngle());
        //Log.e(TAG, "ratio: " + ratio);
        float fovy = p.getVerticalViewAngle() * 1.9f; //This number is hard to get to, it should be manually set.
        //float fovy = p.getHorizontalViewAngle() * 2;
        //Log.e(TAG, "generateProjectionMatrix: ");
