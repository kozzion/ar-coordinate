...
public class Matrix44 {
  ...
  public Matrix44(float[] contents) {
  ...
  public static Matrix44 createScaling(float x, float y, float z) {
  ...
  public static Matrix44 createRotation(float angle, Vector3 axis) {
  ...
  public static Matrix44 createPerspectiveProjection(float width, float height, float fovyInRadians) {
    float near = 0.01f;
    float far = 10000.0f;
  ...
  public static Matrix44 createView(Vector3 lookDir, Vector3 up, Vector3 right) {
    return new Matrix44(new float[] {
        right.x,
        up.x,
        -lookDir.x,
  ...
  public static Matrix44 multiplyMM(Matrix44 mat1, Matrix44 mat2) {
  ...
  public static Vector3 multiplyMV(Matrix44 mat, Vector3 v) {
    float[] m = mat.mValues;
    return new Vector3(
   ...
   */
  public static Vector3 transformVector(Matrix44 mat, Vector3 v) {
